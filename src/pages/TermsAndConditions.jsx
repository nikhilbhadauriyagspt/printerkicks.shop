...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
                 We are PrinterKicks LLC ("Company," "we," "us," "our"), a company registered in North Carolina, United States at 4904 Alpinis Dr, Raleigh, NC 27616.      </p>
      <p>
        We operate the website <a href="http://primefixsolutions.co/">http://printerkicks.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
      ...
      <p>
                                   You can contact us by email at <a href="mailto:info@printerkicks.shop">info@printerkicks.shop</a>, or by mail to 4904 Alpinis Dr, Raleigh, NC 27616, United States.      </p>      <p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://primefixsolutions.co/return-policy">http://printerkicks.shop/return-policy</a>.</p>
