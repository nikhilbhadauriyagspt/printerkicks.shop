...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We are PrinterKicks LLC ("Company," "we," "us," "our"), a company registered in North Carolina, United States at 4904 Alpinis Dr, Raleigh, NC 27616.
      </p>
      <p>
      ...
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and PrinterKicks LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      </p>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@printerkicks.shop">info@printerkicks.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://printerkicks.shop/return-policy">http://printerkicks.shop/return-policy</a>.</p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://printerkicks.shop/privacy-policy">http://printerkicks.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          <p className="text-slate-900 font-black">PrinterKicks LLC</p>
          <p>4904 Alpinis Dr</p>
          <p>Raleigh, NC 27616</p>
          <p>United States</p>
          <p className="pt-4 text-blue-600 font-black">Email: info@printerkicks.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
